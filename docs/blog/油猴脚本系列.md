# 优质油猴脚本合集，来自公众号苏生不惑的整理，更新时间2024-2-25
...
备份微博收藏可以用这个油猴脚本，它能备份微博收藏，发布和点赞，备份以页为单位，每页有20条，可以在输入框设置自已需要备份的页面范围，默认会下载全部数据，为防止保存文件过大，对备份数据分文件保存，默认10页存一个文件，最大可设置20页，备份图片清晰度分为3个等级，等级越大图片越大越清晰，备份完成后，数据自动保存到本地，下载格式为包含html文件和图片资源的 zip 压缩包，解压后使可用谷歌/edge浏览器打开。
...
{"_id":"bilibili_upload","startUrl":["https://space.bilibili.com/38416038/upload/video"],"selectors":[{"id":"container","parentSelectors":["_root"],"type":"SelectorElementClick","clickActionType":"real","clickElementSelector":".vui_pagenation--btns button:last-of-type","clickElementUniquenessType":"uniqueText","clickType":"clickMore","delay":2000,"discardInitialElements":"do-not-discard","multiple":true,"selector":"div.upload-video-card"},{"id":"视频链接","parentSelectors":["container"],"type":"SelectorLink","selector":".bili-video-card__title a","multiple":false,"linkType":"linkFromHref"},{"id":"视频标题","parentSelectors":["container"],"type":"SelectorText","selector":".bili-video-card__title a","multiple":false,"regex":""},{"id":"视频时间","parentSelectors":["container"],"type":"SelectorText","selector":".bili-video-card__subtitle span","multiple":false,"regex":""},{"id":"视频封面","parentSelectors":["container"],"type":"SelectorElementAttribute","selector":".bili-cover-card__thumbnail img","multiple":false,"extractAttribute":"src"}]}
```
# b站热榜
```js
...
# 头条文章
```js
{"_id":"toutiao","startUrl":["https://www.toutiao.com/c/user/token/MS4wLjABAAAAUZKG_KuaxVrOMiwDd3QXX0ZB3Nh4bcv7AFs9ZFpJQMo/?tab=article"],"selectors":[{"id":"container","parentSelectors":["_root"],"type":"SelectorElementScroll","selector":"div.feed-card-article","multiple":true,"delay":2000,"elementLimit":500},{"id":"文章链接","parentSelectors":["container"],"type":"SelectorElementAttribute","selector":"a.title","multiple":false,"extractAttribute":"href"},{"id":"文章标题","parentSelectors":["container"],"type":"SelectorText","selector":"a.title","multiple":false,"regex":""},{"id":"文章阅读数","parentSelectors":["container"],"type":"SelectorText","selector":"div.profile-feed-card-tools-text","multiple":false,"regex":""},{"id":"文章评论数","parentSelectors":["container"],"type":"SelectorText","selector":".feed-card-footer-comment-cmp a","multiple":false,"regex":""},{"id":"文章发布时间","parentSelectors":["container"],"type":"SelectorText","selector":"div.feed-card-footer-time-cmp","multiple":false,"regex":""}]}
```

# 头条微头条

```js
{"_id":"toutiao_top","startUrl":["https://www.toutiao.com/c/user/token/MS4wLjABAAAAUZKG_KuaxVrOMiwDd3QXX0ZB3Nh4bcv7AFs9ZFpJQMo/?tab=wtt"],"selectors":[{"id":"container","parentSelectors":["_root"],"type":"SelectorElementScroll","selector":"div.feed-card-wtt-l","multiple":true,"delay":2000,"elementLimit":500},{"id":"微头条标题","parentSelectors":["container"],"type":"SelectorText","selector":".content a","multiple":false,"regex":""},{"id":"微头条链接","parentSelectors":["container"],"type":"SelectorElementAttribute","selector":".content a","multiple":false,"extractAttribute":"href"},{"id":"微头条发布时间","parentSelectors":["container"],"type":"SelectorText","selector":"div.time","multiple":false,"regex":""}]}
```

# 头条视频
```js
{"_id":"toutiao_video","startUrl":["https://www.toutiao.com/c/user/token/MS4wLjABAAAA1PlMqMPirDP3DJTAiU_fLpYZpDr-UwbPg4cYYi5ZSY1v2N2ZA65vcMIQM-PBEcDa/?tab=video"],"selectors":[{"id":"container","parentSelectors":["_root"],"type":"SelectorElementScroll","selector":"div.feed-card-video-multi-item","multiple":true,"delay":2000,"elementLimit":500},{"id":"视频标题","parentSelectors":["container"],"type":"SelectorText","selector":"a.title","multiple":false,"regex":""},{"id":"视频链接","parentSelectors":["container"],"type":"SelectorElementAttribute","selector":"a.title","multiple":false,"extractAttribute":"href"},{"id":"播放量","parentSelectors":["container"],"type":"SelectorText","selector":"div.profile-feed-card-tools-text","multiple":false,"regex":""},{"id":"评论数","parentSelectors":["container"],"type":"SelectorText","selector":".feed-card-footer-comment-cmp a","multiple":false,"regex":""},{"id":"发布时间","parentSelectors":["container"],"type":"SelectorText","selector":"div.feed-card-footer-time-cmp","multiple":false,"regex":""}]}
```
# 雪球
```js
{"_id":"xueqiu","startUrl":["https://xueqiu.com/u/4742988362"],"selectors":[{"id":"container","parentSelectors":["_root"],"type":"SelectorElementClick","clickActionType":"real","clickElementSelector":".pagination a","clickElementUniquenessType":"uniqueText","clickType":"clickOnce","delay":2000,"discardInitialElements":"do-not-discard","multiple":true,"selector":"article"},{"id":"雪球链接","parentSelectors":["container"],"type":"SelectorElementAttribute","selector":"a.date-and-source","multiple":false,"extractAttribute":"href"},{"id":"雪球时间","parentSelectors":["container"],"type":"SelectorText","selector":"a.date-and-source","multiple":false,"regex":"\\d{4}-\\d{2}-\\d{2} \\d{2}:\\d{2}"},{"id":"转发数","parentSelectors":["container"],"type":"SelectorText","selector":".timeline__item__ft > a:nth-of-type(1) span","multiple":false,"regex":"\\d+"},{"id":"评论数","parentSelectors":["container"],"type":"SelectorText","selector":"a.timeline__item__control:nth-of-type(2) span","multiple":false,"regex":"\\d+"},{"id":"点赞数","parentSelectors":["container"],"type":"SelectorText","selector":"a:nth-of-type(3) span","multiple":false,"regex":"\\d+"}]}

{"_id":"xueqiu","startUrl":["https://xueqiu.com/u/4742988362"],"selectors":[{"clickActionType":"real","clickElementSelector":"a.pagination__next","clickElementUniquenessType":"uniqueText","clickType":"clickMore","delay":2000,"discardInitialElements":"do-not-discard","id":"container","multiple":true,"parentSelectors":["_root"],"selector":"article","type":"SelectorElementClick"},{"extractAttribute":"href","id":"雪球链接","multiple":false,"parentSelectors":["container"],"selector":"a.date-and-source","type":"SelectorElementAttribute"},{"id":"雪球时间","multiple":false,"parentSelectors":["container"],"regex":"\\d{4}-\\d{2}-\\d{2} \\d{2}:\\d{2}","selector":"a.date-and-source","type":"SelectorText"},{"id":"转发数","multiple":false,"parentSelectors":["container"],"regex":"\\d+","selector":".timeline__item__ft > a:nth-of-type(1) span","type":"SelectorText"},{"id":"评论数","multiple":false,"parentSelectors":["container"],"regex":"\\d+","selector":"a.timeline__item__control:nth-of-type(2) span","type":"SelectorText"},{"id":"点赞数","multiple":false,"parentSelectors":["container"],"regex":"\\d+","selector":"a:nth-of-type(3) span","type":"SelectorText"}]}

{"_id":"xueqiu_column","startUrl":["https://xueqiu.com/7824196356/column"],"selectors":[{"id":"container","parentSelectors":["_root"],"type":"SelectorElementClick","clickActionType":"real","clickElementSelector":".pagination a","clickElementUniquenessType":"uniqueText","clickType":"clickOnce","delay":2000,"discardInitialElements":"do-not-discard","multiple":true,"selector":"div.column__item"},{"id":"雪球链接","parentSelectors":["container"],"type":"SelectorElementAttribute","selector":".column__item__title a","multiple":false,"extractAttribute":"href"},{"id":"雪球时间","parentSelectors":["container"],"type":"SelectorText","selector":"div.column__item__time","multiple":false,"regex":"\\d{4}-\\d{2}-\\d{2} \\d{2}:\\d{2}"},{"id":"文章标题","parentSelectors":["container"],"type":"SelectorText","selector":".column__item__title a","multiple":false,"regex":""}]}
```
# 小红书
```js
{"_id":"xiaohongshu","startUrl":["https://www.xiaohongshu.com/user/profile/5eec299c0000000001005ab5?xhsshare=CopyLink&appuid=54433c58d6e4a907f6abdc36&apptime=1731389808&share_id=75bc5b7975584637a371518a23fbcf3a"],"selectors":[{"delay":4000,"elementLimit":500,"id":"content","multiple":true,"parentSelectors":["_root"],"selector":".note-item","type":"SelectorElementScroll"},{"extractAttribute":"href","id":"url","multiple":false,"parentSelectors":["content"],"selector":".cover","type":"SelectorElementAttribute"},{"id":"title","multiple":false,"parentSelectors":["content"],"regex":"","selector":".title span","type":"SelectorText"},{"id":"fav","multiple":false,"parentSelectors":["content"],"regex":"","selector":"span.count","type":"SelectorText"},{"extractAttribute":"src","id":"cover","multiple":false,"parentSelectors":["content"],"selector":".cover img","type":"SelectorElementAttribute"}]}
```
# 当前网页链接
```js
// 获取页面中所有链接元素
...
for (let i = 0; i < links.length; i++) {
    ...
    // 检查链接是否以指定前缀开头
    if (href && href.startsWith('https://www.baidu.com/')) {
        matchedLinks[href] = true;
    }
}

// 提取去重后的链接数组
const uniqueLinks = Object.keys(matchedLinks);

// 将去重后的链接拼接成一个字符串，每个链接之间用换行符分隔
const linksString = uniqueLinks.join('\n');

// 创建一个临时文本域元素
const tempTextArea = document.createElement('textarea');
tempTextArea.value = linksString;
...
alert('链接已去重并复制到剪贴板');
所有 span 标签的第 5 个元素
div.star span:nth-of-type(5)  span[property='v:average'] 
[\u4e00-\u9fa5]
如何抓取二级页面（详情页）的三连数据
创建一个选择器，选的元素是一样的，但是 Type 类型为 Link
滚动到底加载数据 Element scroll down  div.star:nth-of-type(-n+100) ，暂时只抓取前 100 条数据
https://movie.douban.com/top250?start=[0-225:25]&filter=  每隔 25 是一个网页
加载更多   Type 类型为Element click click more  https://www.cnblogs.com/web-scraper/p/web_scraper_start_element_click.html
页面刷新 link翻页 https://www.cnblogs.com/web-scraper/p/web-scraper-fanye-link.html  
next_page  同级下再创建 container 节点 有两个父节点——_root 和 next_page 
页面不刷新 Element Click 翻页  https://www.cnblogs.com/web-scraper/p/web_scraper_element_click_once.html
如果翻页器类型的网页想提前结束抓取，只有断网的这种方法 
```
